...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="index.php" style="color:rgb(133, 14, 53)!important">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="#" style="color:rgb(238, 105, 131)!important">Pricing</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="container mt-5">
        <div class="row mt-5">
            <p class="lead">Default Package</p>
        ...
        <div class="row mt-5">
            <p class="lead">Insured Package</p>
